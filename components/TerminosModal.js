            ...
            >
                ...
                <div className={s.content}>
                    <div className={s.body}>
                        ...
                        <p>7.3 En el caso de los apartados, el saldo restante deberá liquidarse dentro de los 15 días naturales siguientes a la fecha del anticipo. En el caso de las preventas, el plazo es de 30 días naturales y corre a partir de la fecha en que el producto se encuentra disponible en nuestro almacén para su entrega o envío.</p>
                        ...
                        <p>7.7 El precio del apartado no incluye el envío. Una vez liquidado el saldo, el usuario solicita el envío desde la sección &quot;Mis apartados&quot; de su cuenta: indica la dirección de entrega, elige la paquetería y paga el costo de envío vigente ese día, que se muestra antes de pagar. Varios apartados liquidados pueden enviarse juntos en un solo paquete, pagando un solo envío.</p>
                        <p>7.8 No se envía ningún apartado que tenga saldo pendiente. El cargo del envío se hace efectivo cuando BISONTE MANGA confirma el pedido; si por cualquier motivo no pudiera enviarse, el cargo del envío se libera sin costo para el usuario.</p>
