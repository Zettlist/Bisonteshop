 ...
 */
export async function firmarPedidoSaldo({ clienteId, itemsHash, envioDestino, subtotal, discount, credit, shipping, total, couponId }) {
    ...
    const token = await new SignJWT({
        ...
        itemsHash,
        // Y el destino al que se cotizo el envio, por lo mismo: /confirm recibe
        // la direccion en el cuerpo y tiene que poder contrastarla.
        envioDestino: String(envioDestino || ''),
