...
const COLUMNAS = `
    ...
    p.stock,
    p.stock_disponible,
    -- Preventa: el articulo viene en camino y no hay ni una pieza en la tienda.
    -- Se vende igual, contra preventa_disponible en vez de contra el stock, y
    -- apartarlo pide el 50% en lugar del 30% (lib/apartado.js).
    p.estado,
    p.preventa_cantidad,
    p.preventa_reservada,
